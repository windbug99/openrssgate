...
CATEGORY_TAG_MAP: dict[str, tuple[str, ...]] = {
    "ai": ("ai", "agents", "llm", "machine-learning", "robotics"),
    "tech": ("programming", "backend", "frontend", "cloud", "devops", "data"),
    "developer-tools": ("developer-tools", "programming", "tutorial", "backend", "webdev"),
    "business": ("startup", "enterprise", "leadership", "marketing", "analysis"),
    "finance": ("investing", "economy", "fintech", "analysis"),
    "crypto": ("crypto", "investing", "policy"),
    "science": ("research", "analysis", "biotech", "climate"),
    "health": ("healthtech", "biotech", "analysis"),
    "education": ("tutorial", "beginner", "career"),
    "design": ("ux", "product", "analysis"),
    "culture": ("opinion", "analysis", "interview"),
    "entertainment": ("review", "interview", "opinion"),
    "gaming": ("review", "analysis", "daily"),
    "sports": ("analysis", "daily", "breaking-news"),
    "lifestyle": ("productivity", "opinion", "review"),
    "travel": ("review", "local", "global"),
    "food": ("review", "local", "opinion"),
    "fashion": ("review", "creator-economy", "analysis"),
    "hobby": ("tutorial", "review", "beginner"),
    "automotive": ("review", "analysis", "energy"),
    "politics": ("policy", "analysis", "breaking-news"),
    "government": ("policy", "analysis", "local"),
    "security": ("cybersecurity", "privacy", "analysis"),
    "environment": ("climate", "energy", "analysis"),
    "media": ("creator-economy", "social-media", "analysis"),
    "real-estate": ("analysis", "investing", "local"),
    "shopping": ("ecommerce", "review", "analysis"),
    "legal": ("policy", "analysis", "opinion"),
    "industry": ("semiconductor", "enterprise", "analysis"),
}
